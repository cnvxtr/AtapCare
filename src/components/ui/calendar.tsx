...
function Calendar({
  ...
  const defaultClassNames = {
    ...
    day_button:
      "relative flex size-9 items-center justify-center whitespace-nowrap rounded-[5px] p-0 text-foreground outline-offset-2 focus:outline-none focus-visible:z-10 hover:bg-accent group-data-[selected]:bg-primary hover:text-foreground group-data-[selected]:text-primary-foreground group-data-[disabled]:pointer-events-none group-data-[disabled]:text-foreground/30 group-data-[disabled]:line-through group-data-[outside]:text-foreground/30 group-data-[outside]:group-data-[selected]:text-primary-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70",
    day: "group size-9 px-0 text-sm",
    selected:
      "group-data-[selected]:rounded-[5px] group-data-[selected]:bg-primary group-data-[selected]:text-primary-foreground group-data-[selected]:after:hidden",
