...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-lg">
      <div className="px-4 lg:px-6 h-16 grid grid-cols-[auto_1fr_auto] items-center w-full">
        <Link to="/" className="flex items-center gap-2 shrink-0">
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[10px] uppercase tracking-widest text-muted-foreground hidden sm:block">PT Atap Teknologi Indonesia</span>
          </div>
        </Link>
